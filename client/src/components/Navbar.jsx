      ...
      <div className="flex items-center gap-4">
        {token ? (
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <div className="absolute right-0 top-0 pt-14 text-base font-medium text-gray-600 hidden group-hover:block">
          ...
          <button
            ...
            className="bg-primary text-white py-2 px-4 rounded-lg hidden md:block"
          >
            Create Account
          </button>
        )}
